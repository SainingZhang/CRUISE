...
from lib.datasets.dair_loader import readDairFullInfo
# from lib.datasets.dair_loader_single import readDairFullInfo_single
# from lib.datasets.dair_loader_debug import readDairFullInfo_debug
from lib.datasets.dair_loader_multi_seq import readDairFullInfo_multi_seq

sceneLoadTypeCallbacks = {
    "Colmap": readColmapSceneInfo,
    "Blender" : readNerfSyntheticInfo,
    "Waymo": readWaymoFullInfo,
    "Dair": readDairFullInfo,
    "Dair_multi_seq": readDairFullInfo_multi_seq,
    # "Dair_single": readDairFullInfo_single,
    # "Dair_debug": readDairFullInfo_debug,
}
...
class Dataset():
    def __init__(self):
        ...
        self.sequence_id = cfg.specified_sequence_id
